...
javac -cp ".;$JDBC_JAR;$JUNIT_JAR" backend\*.java Unit_Testing\CreateTransactionGroupTest.java -d $OUT_DIR
...
java -cp "$OUT_DIR;$JDBC_JAR;$JUNIT_JAR" org.junit.platform.console.ConsoleLauncher --select-class=CreateTransactionGroupTest